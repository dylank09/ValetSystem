        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(
                    decimal_places=2, default=0.0, max_digits=200)),
                ('store', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='valetapp.chainstore')),
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='valetapp.customer')),
            ],

# Generated by Django 3.2.9 on 2021-11-03 13:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True,
                 primary_key=True, serialize=False, verbose_name='ID')),
                ('valetType', models.CharField(choices=[('WXW', 'Wax&Wash'), ('INW', 'Interior&Wash'), (
                    'PWH', 'Polish&Wash'), ('ALL', 'All'), ('WAS', 'Wash')], max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('membershipType', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.RESTRICT, to='valetapp.membershiptype')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
...
=======
                ('valetservice', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='valetapp.valetservice')),
>>>>>>> 7a59b91c9766a67e27405d595aedf7c1425ab5f0
            ],
        ),
    ]
